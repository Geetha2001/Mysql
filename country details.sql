...
CREATE TABLE country_detls(id int not null unique, 
state_name varchar(30) not null unique,
 capital_name varchar(30) not null unique, 
 crop varchar(30) not null unique, 
 festival varchar(30) not null unique, 
 official_language varchar(30) not null unique,
 largest_city varchar(30) not null unique, 
 total_area varchar(30) not null unique,
 female_population bigInt, 
 check (female_population <= 100000),
 no_of_districts int ,
 check(no_of_districts <= 60));
